...
interface IJSON {
  ...
  export default function OpenVault({setVault}: {setVault: (arg: Vault) => void}) {
    ...
    return (
      <div className="flex flex-col items-center justify-center mt-5 w-[300px] m-auto" onDrop={onDrop} onDragOver={onDragOver} >
        ...
        <div className={`relative mb-1 mt-5 w-full ${!incorrect ? 'mb-6' : null}`}>
        ...
        {incorrect && <p className="text-center text-red-400 mb-4">incorrect password</p>}
        <button disabled={!enc} onClick={onOpen} type="button" className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 ">OPEN</button>
      </div>
    )
  }   